...
class TestIndexRegistry(unittest.TestCase):
    ...
    def test_get_indices_from_elasticsearch_shards(self):
        ...
        index_registry.get_indices_from_elasticsearch(
            elk_client, index="index-2018.08.20", doc_type="_doc"
        )
        ...
        return {
            "index-2018.08.20": {
                "mappings": {
                    "_doc": {
                        "properties": {
                            "activity_earliest": {"type": "date"},
                            "activity_latest": {"type": "date"},
                            ...
                            "raised_at": {"type": "date"},
                            "score": {"type": "integer"},
                            "syslog_description": {"type": "keyword"},
    ...
    def __cluster_info():
        return {
            ...
            "cluster_uuid": "cLJp20vFS4eNva9nyj1crg",
            "version": {
                "number": "7.3.0",
                ...
                [
                    {
                        ...
                        "allocation_id": {"id": "7gsIfTB5RTm8BoR29Sff7g"},
                    }
                ],
                [
                    {
                        ...
                        "shard": 1,
                        "index": "index-2018.08.20",
                        "allocation_id": {"id": "53hs_j-nRbioSiah3hiYAw"},
                    }
                ],
                [
                    {
                        ...
                        "shard": 2,
                        "index": "index-2018.08.20",
                        "allocation_id": {"id": "7LiMF80YSOmCT_e0ZWYjrg"},
                    }
                ],
                [
                    {
                        ...
                        "shard": 3,
                        "index": "index-2018.08.20",
                        "allocation_id": {"id": "P_vAnbMcQU20yB3Stmvb5A"},
                    }
                ],
                [
                    {
                        ...
                        "shard": 4,
                        "index": "index-2018.08.20",
                        "allocation_id": {"id": "8fwaA0kWTCeI01tUxW-K1Q"},
                    }
                ],
            ],
        }
    ...
    def __mocked_shards():
        return [
            {"index": "index-2018.08.20", "shard": "1", "prirep": "p", "docs": "8"},
            {"index": "index-2018.08.20", "shard": "1", "prirep": "r", "docs": None},
            {"index": "index-2018.08.20", "shard": "3", "prirep": "p", "docs": "6"},
            {"index": "index-2018.08.20", "shard": "3", "prirep": "r", "docs": None},
            {"index": "index-2018.08.20", "shard": "4", "prirep": "p", "docs": "1"},
            {"index": "index-2018.08.20", "shard": "4", "prirep": "r", "docs": None},
            {"index": "index-2018.08.20", "shard": "2", "prirep": "p", "docs": "6"},
            {"index": "index-2018.08.20", "shard": "2", "prirep": "r", "docs": None},
            {"index": "index-2018.08.20", "shard": "0", "prirep": "p", "docs": "5"},
            {"index": "index-2018.08.20", "shard": "0", "prirep": "r", "docs": None},
        ]
